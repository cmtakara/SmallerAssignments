...
function doWeContinue(myShip, numEnemyRemaining) {
    ...
    console.log("You won that battle.  You have " + myShip.hullNow + " hull.  There are " + numEnemyRemaining + " ships remaining");
    const readline = require('readline').createInterface({
        input: process.stdin,
        output: process.stdout
    });

    readline.question('Do you want to continue? \n enter y or n: ', yORn => {
    if (yORn == 'y' || yORn == 'Y') {
        //play the game
        console.log("You pressed OK! We will Continue");
        keepGoing = true;
    } else if (yORn == 'n' || yORn == 'N') {
        //don't play
        console.log("You pressed Cancel! We will retreat - FOR NOW");
        keepGoing = false;
    } else {
        //neither y nor n
        console.log('I didn"t understand your input, so we will retreat');
        keepGoing = false;
    }
    readline.close();
});
...
// This is the logic for the html output
//   if (confirm("You won that battle.  You have " + myShip.hullNow + " hull.  There are " + numEnemyRemaining + " ships remaining")) {
...
// This is the code that I modeled the question from
...
let startGame = false;
readline.question('Do you want to play the game? \n enter y or n: ', yORn => {
    if (yORn == 'y' || yORn == 'Y') {
        //play the game
        console.log('You chose yes, so let"s get started');
        playGame();
        startGame = true;
    } else if (yORn == 'n' || yORn == 'N') {
        //don't play
        ...
        //neither y nor n
        console.log('I didn"t understand your input');
    }
    readline.close();
});
